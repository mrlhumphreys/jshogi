...
describe('Ryuuou', () => {
  describe('destinations', () => {
    it('must return only valid destinations', () => {
      let ryuuou = new Ryuuou({ id: 17, player_number: 1, type: 'ryuuou'});
      let origin = new Square({id: '88', x: 1, y: 7, piece: ryuuou});
      ...
      let result = ryuuou.destinations(origin, gameState);
    ...
    it('must return occupied by opponent squares', () => {
      ...
      let diagonalFar = new Square({id: '66', x: 3, y: 5, piece: { id: 3, player_number: 2, type: 'fuhyou' }}); 
      let occupied = new Square({id: '85', x: 1, y: 4, piece: { id: 18, player_number: 1, type: 'fuhyou'}}); 
      let blocked = new Square({id: '84', x: 1, y: 3, piece: { id: 4, player_number: 2, type: 'fuhyou' }}); 
      let diagonalForward = new Square({id: '77', x: 2, y: 6, piece: { id: 5, player_number: 2, type: 'fuhyou' }}); 
    ...
    it('must not return occupied by player squares', () => {
      ...
      let diagonalFar = new Square({id: '66', x: 3, y: 5, piece: { id: 3, player_number: 1, type: 'fuhyou' }}); 
      let occupied = new Square({id: '85', x: 1, y: 4, piece: { id: 18, player_number: 1, type: 'fuhyou'}}); 
      let blocked = new Square({id: '84', x: 1, y: 3, piece: { id: 4, player_number: 1, type: 'fuhyou' }}); 
      let diagonalForward = new Square({id: '77', x: 2, y: 6, piece: { id: 5, player_number: 1, type: 'fuhyou' }}); 
