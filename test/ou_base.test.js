...
describe('OuBase', () => {
  describe('destinations', () => {
    it('must return only valid destinations', () => {
      let ouBase = new OuBase({ id: 17, player_number: 1, type: 'ou_base'});
      let origin = new Square({id: '88', x: 1, y: 7, piece: ouBase});
      ...
      let result = ouBase.destinations(origin, gameState);
    ...
    it('must return occupied by opponent squares', () => {
      let ouBase = new OuBase({ id: 17, player_number: 1, type: 'ou_base'});
      let origin = new Square({id: '88', x: 1, y: 7, piece: ouBase});
      let forward = new Square({id: '87', x: 1, y: 6, piece: { id: 18, player_number: 2, type: 'fuhyou'}}); 
      let far = new Square({id: '86', x: 1, y: 5, piece: { id: 19, player_number: 2, type: 'fuhyou' }}); 
      let diagonalForward = new Square({id: '77', x: 2, y: 6, piece: { id: 20, player_number: 2, type: 'fuhyou' }}); 
      let side = new Square({id: '78', x: 2, y: 7, piece: { id: 21, player_number: 2, type: 'fuhyou' }}); 
      let diagonalBack = new Square({id: '79', x: 2, y: 8, piece: { id: 22, player_number: 2, type: 'fuhyou' }}); 
      let back = new Square({id: '89', x: 1, y: 8, piece: { id: 23, player_number: 2, type: 'fuhyou' }}); 
      let gameState = new GameState({
        current_player_number: 1, 
        squares: [
          origin,
    ...
    it('must not return occupied by player squares', () => {
      let ouBase = new OuBase({ id: 17, player_number: 1, type: 'ou_base'});
      let origin = new Square({id: '88', x: 1, y: 7, piece: ouBase});
      let forward = new Square({id: '87', x: 1, y: 6, piece: { id: 18, player_number: 1, type: 'fuhyou'}}); 
      let far = new Square({id: '86', x: 1, y: 5, piece: { id: 19, player_number: 1, type: 'fuhyou' }}); 
      let diagonalForward = new Square({id: '77', x: 2, y: 6, piece: { id: 20, player_number: 1, type: 'fuhyou' }}); 
      let side = new Square({id: '78', x: 2, y: 7, piece: { id: 21, player_number: 1, type: 'fuhyou' }}); 
      let diagonalBack = new Square({id: '79', x: 2, y: 8, piece: { id: 22, player_number: 1, type: 'fuhyou' }}); 
      let back = new Square({id: '89', x: 1, y: 8, piece: { id: 23, player_number: 1, type: 'fuhyou' }}); 
      let gameState = new GameState({
        current_player_number: 1, 
        squares: [
          origin,
